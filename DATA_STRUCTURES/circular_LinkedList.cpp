...
class CircularLinkedList
{
	public:
		...
		void appendNode(Node *new_node)
		{
			...
			{
				cout<<"Node With This Key Is Already Present "<<endl;
			}
			else
			{
				if(head == NULL)
				{
					head = new_node;
					new_node->next = head;
					cout<<"Node Appended In The Empty List"<<endl;
				}
		...
		void insertNodeAfter(int k, Node *new_node)
		{
			...
			else
			{
				if(nodeExists(new_node->key) != NULL)
				{
					cout<<"Node Exists With This Key Value" <<endl;
				}
				else
				{
					if(ptr->next == head)
		...
		void deleteNodeByKey(int k)
		{
			...
			if(ptr==NULL)
			{
				cout<<"Node Wth This Key Exists"<<endl;
			}
			else
			{
				if(ptr == head)
		...
		void updateNodeByKey(int k , int new_data)
		{
			...
			{
				cout<<"Node Does Not Exists With This Key Value"<<endl;
			}
		}
